...
## BIOLOGICAL CONTEXT: 
Aldehyde dehydrogenase 1a3 (ALDH1A3) converts retinaldehyde into all-trans retinoic acid (atRA) which was historically assumed to supress tumors. This study shows that ALDH1A3-expressing cancers lose sensitivity to retinoid signaling. Instead, the atRA produced by ALDH1A3 acts in a paracrine fashion to suppress anti-tumor immunity rather than acting on the tumor cells themselves. The researchers developed MBE1.5, an ALDH1A3 inhibitor, to observe how ALDH1A3 inhibition changes gene expression in cancer cell lines (Esposito et al., 2025, iScience 28, 113675).
